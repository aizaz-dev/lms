...
<div class="container-fluid py-4" style="min-height: 700px;">
	...
	if(isset($_GET['msg']))
	{
		...
		if($_GET['msg'] == 'enable')
		{
			echo '<div class="alert alert-success alert-dismissible fade show" role="alert">Category Deleted <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button></div>';
		}
	}	
				...
				if($statement->rowCount() > 0)
				{
					foreach($statement->fetchAll() as $row)
					{
						...
						<tr>
							...
							<td data-label="Created on">'.$row["category_created_on"].'</td>
							<td data-label="Update on">'.$row["category_updated_on"].'</td>
